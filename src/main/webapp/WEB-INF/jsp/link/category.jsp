...
<div class="col-xs-12" id="privateProfile">
	<ul class="nav nav-tabs" id="submenu"><!-- 两端对齐 nav-justified -->
		...
		<li role="presentation" class="active" onclick="switch_selected(this)"><a href="${pageContext.request.contextPath}/directory_manager?tab=category" class="pjax">题目类型</a></li>
