...
<div class="col-xs-12" id="privateProfile">
	<ul class="nav nav-tabs" id="submenu"><!-- 两端对齐 nav-justified -->
		<li role="presentation" class="" onclick="switch_selected(this)"><a href="${pageContext.request.contextPath}/directory_manager?tab=section" class="pjax">课程章节</a></li>
		...
		<li role="presentation" class="active" onclick="switch_selected(this)"><a href="${pageContext.request.contextPath}/directory_manager?tab=subjectinfo" class="pjax">课程信息</a></li>
	</ul>
